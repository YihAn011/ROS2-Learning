...
bool base_interfaces_demo__msg__student__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._student.Student", full_classname_dest, 41) == 0);
  }
  base_interfaces_demo__msg__Student * ros_message = _ros_message;
  {  // name
...
PyObject * base_interfaces_demo__msg__student__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._student");
